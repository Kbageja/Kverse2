...
const Button2 = ({onClick, children = "Discover More", className, ...rest }) =>{
  return (
    <button className={` relative border hover:border-sky-600 duration-500 group cursor-pointer text-sky-50  overflow-hidden h-14 w-56 rounded-md bg-sky-800 p-2 flex justify-center items-center font-extrabold ${className}`} onClick={onClick}
    {...rest}
    role="button">
