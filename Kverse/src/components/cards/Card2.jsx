...
import './Card2.css'
const Card2 = ({Place,Temperature,Humidity,Wind,AQI,Realfeel,Pressure ,className, ...rest })=> {
  return (
    <div className={`cardm ${className}`}>
    <div class="card">
      ...
      <div class="main">{Temperature}</div>
      <div class="mainsub">{Place}</div>
    ...
    <div class="card2">
      ...
      <div class="lower">
        ...
        <div class="realfeel">
          ...
          <div class="realfeeltext">Real Feel<br/>{Realfeel}</div>
        </div>
